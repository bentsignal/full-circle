...
type _ButtonRequiresCounter = Expect<Equal<Requirements<typeof CounterButton>, CounterRequirement>>;
type _RowBubblesCounter = Expect<Equal<Requirements<typeof CounterRow>, CounterRequirement>>;
