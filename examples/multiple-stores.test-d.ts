...
type _OneComponentCanRequireTwoStores = Expect<
  Equal<Requirements<typeof IdentityBadge>, ViewerRequirement | ThemeRequirement>
>;
...
type _ProvidingViewerLeavesTwo = Expect<
  Equal<Requirements<typeof ViewerProvidedDashboard>, ThemeRequirement | WorkspaceRequirement>
>;
type _ProvidingViewerAndThemeLeavesWorkspace = Expect<
  Equal<Requirements<typeof ViewerAndThemeProvidedDashboard>, WorkspaceRequirement>
>;
