...
Consumer satisfies Component<ComponentRequirements<FirstRequirement | SecondRequirement>>;
...
type _PropfulConsumerRequirements = Expect<
  Equal<Requirements<typeof PropfulConsumer>, FirstRequirement | SecondRequirement>
>;

const Boundary = createComponent({ ui: () => null });
const _FirstProvided = Boundary.__fullCircleProvidedRequirements([First], Consumer);
const _BothProvided = Boundary.__fullCircleProvidedRequirements([First, Second], Consumer);

type _FirstProvidedRequirements = Expect<
  Equal<Requirements<typeof _FirstProvided>, SecondRequirement>
>;
type _BothProvidedRequirements = Expect<Equal<Requirements<typeof _BothProvided>, never>>;
