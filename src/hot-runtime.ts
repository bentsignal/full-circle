...
export type HotComponentState<Definition> = {
  ...
  readonly publish: (definition: Definition, signatures: HotComponentSignatures) => void;
  readonly subscribe: (listener: () => void) => () => void;
};

type HotComponentRecord = {
  readonly component: unknown;
  readonly publish: (definition: unknown, signatures: HotComponentSignatures) => void;
};
...
const hotRegistryKey = Symbol.for("full-circle/hot-registry");
