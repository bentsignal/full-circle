...
/**
 * Creates an immutable-snapshot external store suitable for typed injection.
 */
export function makeStore<State>(initialState: State, options: StoreOptions<State> = {}) {
